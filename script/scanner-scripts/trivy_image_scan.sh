...
if [ $build_docker == true ];then
	...
	wget https://github.com/aquasecurity/trivy/releases/download/${TRIVY_VERSION}/trivy_${TRIVY_VERSION#v}_Linux-arm64.tar.gz
	tar -xzf trivy_${TRIVY_VERSION#v}_Linux-arm64.tar.gz
        chmod +x trivy
